...
<div class="box-header with-border">
  <h3 class="box-title">
    Pilih siswa yang melakukan pelanggaran <br> Kelas <?php echo $d1['nama_kelas'] ?> <br>
...
<div class="pull-right">
      ...
      <a href="?a=pelanggaran" class="btn btn-info btn-sm"  >Kembali</a>
    </div>
...
left join siswa s on ks.id_siswa = s.id_siswa where ks.id_kelas='$id'  and ks.id_ta='$id_ta' order by s.nama_siswa asc");
  ...
  ?>
    ...
    <td><?php echo $data['nama_siswa']; ?></td>
      ...
      <a href="" class=" btn btn-info btn-xs"  data-toggle="modal" data-target="#input_pelanggaran_<?php echo $data['id_siswa'] ?>">Input Pelanggaran</a>
  	</td>

    <div class="modal fade" id="input_pelanggaran_<?php echo $data['id_siswa'] ?>">
      <form action="form/pelanggaran/simpan_pelanggaran.php" method="post"  enctype="multipart/form-data">
                <div class="modal-dialog">
                  <div class="modal-content">
                    ...
                    <div class="form-group">
                        <label>Kasus</label>
                        <textarea class="form-control" name="kasus" rows="5"></textarea>
                    </div>
                    <div class="form-group">
